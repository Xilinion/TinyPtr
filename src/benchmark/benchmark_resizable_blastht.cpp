...
std::vector<std::tuple<uint64_t, double, uint64_t>> BenchmarkResizableBlastHT::YCSBRunWithLatencyRecording(
...
std::vector<std::tuple<uint64_t, double, uint64_t>> BenchmarkResizableBlastHT::ConcurrentRunWithLatencyRecording(
